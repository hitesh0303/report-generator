        ...
        return (
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    {/* Attendance data table - showing all records without pagination */}
                    <View style={styles.attendanceTable}>
                        <View style={styles.table}>
                            ...
                            {excelData && excelData.length > 0 ? (
                                // Display all entries in one continuous table
                                excelData.map((row, index) => {
                                    // Get Sr No with fallbacks
                                    const srNo = row['Sr No'] !== undefined ? 
                                        String(row['Sr No']) : 
                                        (row['id'] !== undefined ? 
                                            String(row['id']) : 
                                            String(index + 1));
                                    ...
                                    return (
                                        <View style={styles.tableRow} key={index}>
                                            <Text style={styles.tableCell}>{srNo}</Text>
                                ...
                                <View style={styles.tableRow}>
                                    <Text style={[styles.tableCell, { flex: 4, textAlign: 'center', color: '#666' }]}>
        ...
        <Document>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.t33}>{organizer}</Text> 
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.tt2}>
                        <Text style={styles.t44}>Organized by:</Text>
                        <Text style={styles.t55}> {organizer}</Text>
                    </View>
            ...
            {/* CO/PO/PSO and Impact Analysis Page */}
            <Page size="A4" style={styles.page}>
                <View style={styles.headerRow}>
                    <Image style={[styles.logoImage, { height: 65, width: 70 }]} src="/pict_logo.png" />
                    <Text style={[styles.t1, { marginBottom: 2 }]}>
                ...
                <View style={styles.section}>
                    <Text style={styles.t1}>Department of Information Technology{'\n'}</Text>
                    <Text style={styles.t88}>CO / PO / PSOs Addressed:</Text>
                    <View style={styles.table}>
                        {/* Dynamically render CO/PO mappings */}
                        {coPoMapping && coPoMapping.length > 0 ? (
                            coPoMapping.map((mapping, index) => (
                                <View style={styles.tableRow} key={index}>
                                    <Text style={styles.tableCellHeader}>{mapping.code}</Text>
                            ...
                            // Default placeholder if no mappings are provided
                            <View style={styles.tableRow}>
                                <Text style={[styles.tableCell, { flex: 4, textAlign: 'center', color: '#666' }]}>
                                    No CO/PO mappings available
                                </Text>
                            </View>
                        )}
                    </View>
                    ...
                    <View style={styles.tt2}>
                        <Text style={styles.t44}>Name of Resource person: </Text>
                        <Text style={styles.t55}> {resourcePerson}</Text>
                    </View>

                    <Text style={styles.t88}>Impact analysis: </Text>
                    <Text style={styles.t99}>The Expert Session conducted on Quantum Computing has its impact in following several 
                    ...
                    {impactAnalysis.map((impact, index) => (
                        <View key={index} style={styles.tt}>
                            ...
                            {/* <Text style={styles.t99}>{impact.content}</Text> */}
                        </View>
                    ))}
                </View>
            </Page>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.gridContainer}>
                        {/* Show first 4 images, or placeholders if fewer */}
                        ...
                        <View style={styles.gridContainer}>
                            ...
                            {categorizedImages.team.length < 8 && 
                                Array.from({ length: 8 - categorizedImages.team.length }).map((_, index) => (
                                    <View key={`placeholder-${index}`} style={styles.imageContainer}>
                                        <SafeImage src="/Picture2.jpg" style={styles.image1} />
                                    </View>
                                ))
                            }
                        </View>
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.gridContainer}>
                        {/* Show up to 4 question set images, or placeholders if fewer */}
                        {/* Using 'speakers' array for question set images (for backward compatibility) */}
                        ...
                        <Page key={`certificate-page-${index}`} size="A4" style={styles.page}>
                            ...
                            <View style={[styles.section, { paddingTop: 5, marginTop: 0 }]}>
                                ...
                                <Text style={[styles.t5, { marginBottom: 10 }]}>
                                    {index === 0 ? "Approval Letters & Documents:" : `Approval Document ${index + 1}:`}
                                </Text>
