    ...
    return (
      <>
        <div className="mb-8">
          ...
          {/* Event Time */}
          <div>
              <label className="block text-gray-700 text-sm font-medium mb-2">Event Time</label>
            <input
              type="text"
          ...
          {/* Organized By */}
          <div>
              <label className="block text-gray-700 text-sm font-medium mb-2">Organized By</label>
            <input
              type="text"
          ...
          {/* Mode of Conduction */}
          <div>
              <label className="block text-gray-700 text-sm font-medium mb-2">Mode of Conduction</label>
            <input
              type="text"
              value={formData.mode}
          ...
          <div className="col-span-1 md:col-span-2">
              <label className="block text-gray-700 text-sm font-medium mb-2">Link (if Online)</label>
            <input
              type="text"
              value={formData.link}
          ...
          {/* Participants */}
          <div>
              <label className="block text-gray-700 text-sm font-medium mb-2">Number of Students Participated</label>
            <input
              type="text"
          ...
          {/* Resource Person */}
          <div>
              <label className="block text-gray-700 text-sm font-medium mb-2">Name of Resource Person</label>
            <input
              type="text"
        ...
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-4 pb-2 border-b border-gray-200">Objectives & Outcomes</h3>
        
        {/* Objectives */}
          <div className="mb-5">
            <label className="block text-gray-700 text-sm font-medium mb-2">Objectives</label>
        ...
        {/* Outcomes */}
          <div className="mb-5">
            <label className="block text-gray-700 text-sm font-medium mb-2">Outcomes</label>
        ...
        <div className="mb-8">
          ...
          <button
            ...
            className="mt-2 flex items-center text-sm text-blue-600 hover:text-blue-800"
          >
            <FaPlus className="mr-1" /> Add CO/PO/PSO Mapping
          </button>
        </div>
        ...
        <div className="mb-8">
          ...
          <button
            ...
            className="mt-2 flex items-center text-sm text-blue-600 hover:text-blue-800"
          >
            <FaPlus className="mr-1" /> Add Impact Analysis Item
          </button>
        </div>
        ...
        <div className="mb-8">
          ...
          {/* Custom upload button */}
            ...
            className="mb-4 flex items-center p-3 border-2 border-dashed border-blue-300 rounded-md text-blue-500 hover:text-blue-700 hover:border-blue-500 transition duration-200"
                    >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                ...
                <CloudinaryUploader 
                  ...
                  buttonText="Upload Approval Letters & Documents"
                  folder="expert_images"
                  maxFiles={5}
                  category="document"
                  className="mb-2"
