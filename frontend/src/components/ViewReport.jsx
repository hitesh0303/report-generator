  ...
  return (
    <div className="max-w-6xl mx-auto p-8">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        {/* Outcomes Sections for Different Report Types */}
        
        {/* Expert Report Outcomes */}
        {report.reportType === 'expert' && report.outcomes && (
          <div className="mb-8">
            ...
            {Array.isArray(report.outcomes) ? (
              ...
              <p className="text-gray-700 whitespace-pre-line">{report.outcomes}</p>
            )}
          </div>
        )}
        
        {/* PDA Report Outcomes */}
        {report.reportType === 'pda' && report.outcomes && (
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4">Outcomes</h3>
            {Array.isArray(report.outcomes) ? (
              <ul className="list-decimal list-inside space-y-2">
        ...
        {/* Teaching Report Learning Outcomes */}
